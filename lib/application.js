...
var express = require("express")
  ...
  , brand = require('./middleware/brand.js')
  , url = require('./middleware/url.js')
...
app.configRoute = function() {
	var app = this;
	//app.get("/:table/:id/:action.:format?", db.table());
	...
	app.post("/:table/create.:format?", db.upload(), db.create, route.create);
	app.get("/:table/:id/edit.:format?", route.edit);
	app.put("/:table/:id/update.:format?", db.upload(), db.update, route.update);
