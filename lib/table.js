...
table._fillDefaultData = function(type, obj){
	...
	this.columns().forEach(function(col){
		if(obj[col.name] === undefined) {
			var value = typeof col.value == "function" ? col.value.call(null, type, obj) : col.value;
			if(value !== undefined){
				obj[col.name] = value;
			}
		}
...
table.new = function(params, fn){
	var obj = this._fillDefaultData("new", extend({}, params, this.conditions()));
