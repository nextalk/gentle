...
table._fillDefaultData = function(type, obj){
	obj = obj || {};
...
table.new = function(params, fn){
	var obj = this._fillDefaultData("value", extend({}, params, this.conditions()));
	this._selectData(obj, function(err){
		fn && fn(err, obj);
	});
}
...
table.update = function(id, obj, fn, checkPermit){
	...
	data = this._fillDefaultData("update", data);
...
table.create = function(obj, fn, checkPermit){
	...
	data = this._fillDefaultData("create", data);
	if(Object.keys(data).length){
